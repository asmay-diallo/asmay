...
//   checking: {
//     label: "Vérification",
//     description: "Vérification de la compatibilité eSIM...",
//     icon: "phone-portrait-outline",
//     color: "#f87305ff",
//   },
//   installing: {
//     label: "Installation",
//     description: "Téléchargement du profil eSIM sur votre appareil...",
//     icon: "download-outline",
//     color: "#f87305ff",
//   },
//   activating: {
//     label: "Activation",
//     description: "Configuration et activation du forfait...",
//     icon: "cellular-outline",
//     color: "#f87305ff",
//   },
//   completed: {
//     label: "Installé !",
//     description: "Votre eSIM est prête à être utilisée",
...
//         setErrorMessage(error.message || "Erreur inconnue lors de l'installation");
//       }
//     };
// 
//     runInstallation();
...
//             },
//             currentStep === "completed" && styles.iconContainerCompleted,
//             currentStep === "error" && styles.iconContainerError,
//           ]}
//         >
...
//           style={[
//             styles.title,
//             currentStep === "completed" && styles.titleSuccess,
//             currentStep === "error" && styles.titleError,
//           ]}
//         >
//           {step.label}
//         </Text>
//         <Text style={styles.description}>
//           {currentStep === "error" ? errorMessage : step.description}
//         </Text>
// 
//         {/* Info produit */}
//         {productName && (
...
//               </Text>
//               {iccid && (
//                 <Text style={styles.productIccid} numberOfLines={1}>
//                   ICCID: {iccid}
//                 </Text>
//               )}
//             </View>
...
//           {(["checking", "installing", "activating"] as InstallationStep[]).map(
//             (s, index) => {
//               const stepConfig = STEPS[s];
//               const isActive = currentStep === s;
//               const isPast =
//                 (s === "checking" &&
//                   ["installing", "activating", "completed"].includes(currentStep)) ||
//                 (s === "installing" &&
//                   ["activating", "completed"].includes(currentStep)) ||
//                 (s === "activating" && currentStep === "completed");
...
//                     style={[
//                       styles.stepDot,
//                       isActive && { backgroundColor: stepConfig.color, borderColor: stepConfig.color },
//                       isPast && { backgroundColor: "#00CC88", borderColor: "#00CC88" },
//                       !isCurrentOrPast && { backgroundColor: "#F0F2F5", borderColor: "#E1E5EB" },
//                     ]}
//                   >
//                     {isPast ? (
...
//                       style={[
//                         styles.stepLabel,
//                         isCurrentOrPast && styles.stepLabelActive,
//                       ]}
//                     >
//                       {stepConfig.label}
//                     </Text>
...
//                   </View>
//                   {isActive && (
//                     <ActivityIndicator size="small" color={stepConfig.color} />
//                   )}
//                 </View>
//               );
//             }
...
//             <Text style={styles.finishButtonText}>Voir mon eSIM</Text>
//           </TouchableOpacity>
//         )}
// 
//         {currentStep === "error" && (
...
//       </View>
// 
//       {/* Bouton retour (seulement si pas en cours d'installation) */}
//       {(currentStep === "completed" || currentStep === "error") && (
//         <TouchableOpacity
